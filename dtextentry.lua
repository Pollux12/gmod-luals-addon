...
---@realm client
---@realm menu
---@source https://wiki.facepunch.com/gmod/DTextEntry:GetDisabled
...
---@realm client
---@realm menu
---@source https://wiki.facepunch.com/gmod/DTextEntry:SetDisabled
...
---@realm client
---@realm menu
---@source https://wiki.facepunch.com/gmod/DTextEntry:SetValue
...
---@realm client
---@realm menu
---@source https://wiki.facepunch.com/gmod/DTextEntry:UpdateFromMenu
