...
---@param texture_from ITexture The texture to copy from.
---@param texture_to ITexture The texture being copied to.
...
---@return number # The directX version.
...
---Returns the fog mode. In 2D post-processing hooks, the value **MATERIAL_FOG_NONE** will be returned, starting from [GM:PreDrawEffects](https://wiki.facepunch.com/gmod/GM:PreDrawEffects).
---@realm client
...
---@return boolean # Returns `true` when a screenshot is being taken.
function render.IsTakingScreenshot() end
...
---@overload fun(enabled: boolean, sourceColorMultiplier: BLEND, destinationColorMultiplier: BLEND, colorBlendingFunction: BLENDFUNC, sourceAlphaMultiplier?: BLEND, destinationAlphaMultiplier?: BLEND, alphaBlendingFunction?: BLENDFUNC)
...
---@param rtIndex number The index of output `COLOR[n]` [semantics](https://learn.microsoft.com/en-us/windows/win32/direct3dhlsl/dx-graphics-hlsl-semantics) from pixel-shader. Min: `0`, max: `3`.
---@param texture? ITexture The new render target to be used.
