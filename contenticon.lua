...
---An [Global.AccessorFunc](https://wiki.facepunch.com/gmod/Global.AccessorFunc) that returns the color set by [ContentIcon:SetColor](https://wiki.facepunch.com/gmod/ContentIcon:SetColor)
---@realm client
---@source https://wiki.facepunch.com/gmod/ContentIcon:GetColor
...
---An [Global.AccessorFunc](https://wiki.facepunch.com/gmod/Global.AccessorFunc) that sets the color for the content icon. Currently is not used by the content icon panel.
---@realm client
---@source https://wiki.facepunch.com/gmod/ContentIcon:SetColor
...
---@realm client
---@source https://wiki.facepunch.com/gmod/ContentIcon:SetMaterial
...
---@realm client
---@source https://wiki.facepunch.com/gmod/ContentIcon:SetName
