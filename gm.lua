...
---@hook EntityNetworkedVarChanged
---@realm shared
...
---@hook HandlePlayerArmorReduction
---@realm server
...
---@hook OnEntityWaterLevelChanged
---@realm server
...
---@hook OnPauseMenuBlockedTooManyTimes
---@realm menu
...
---@hook PlayerCanHearPlayersVoice
---@realm server
...
---@hook WorkshopSubscriptionsChanged
---@realm menu
...
---@hook WorkshopSubscriptionsMessage
---@realm menu
...
---@hook WorkshopSubscriptionsProgress
---@realm menu
