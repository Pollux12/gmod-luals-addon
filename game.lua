...
---@realm shared
---@source https://wiki.facepunch.com/gmod/game.AddAmmoType
...
---@realm shared
---@source https://wiki.facepunch.com/gmod/game.AddDecal
...
---@realm shared
---@source https://wiki.facepunch.com/gmod/game.AddParticles
...
---**INTERNAL**: Consider using [game.GetAmmoTypes](https://wiki.facepunch.com/gmod/game.GetAmmoTypes) and [game.GetAmmoData](https://wiki.facepunch.com/gmod/game.GetAmmoData) instead.
---
--- Called by the engine to retrieve the ammo types.
---@realm shared
---@source https://wiki.facepunch.com/gmod/game.BuildAmmoTypes
...
---@realm shared
---@source https://wiki.facepunch.com/gmod/game.CleanUpMap
...
---@realm server
---@source https://wiki.facepunch.com/gmod/game.ConsoleCommand
...
---@realm shared
---@source https://wiki.facepunch.com/gmod/game.GetAmmoDamageType
...
---@realm shared
---@source https://wiki.facepunch.com/gmod/game.GetAmmoData
...
---@realm shared
---@source https://wiki.facepunch.com/gmod/game.GetAmmoForce
...
---@realm shared
---@source https://wiki.facepunch.com/gmod/game.GetAmmoID
...
---@realm shared
---@source https://wiki.facepunch.com/gmod/game.GetAmmoMax
...
---@realm shared
---@source https://wiki.facepunch.com/gmod/game.GetAmmoName
...
---@realm shared
---@source https://wiki.facepunch.com/gmod/game.GetAmmoNPCDamage
...
---@realm shared
---@source https://wiki.facepunch.com/gmod/game.GetAmmoPlayerDamage
---@param id number Ammo ID to retrieve the damage info of. Starts from 1.
---@return number #
...
---@realm shared
---@source https://wiki.facepunch.com/gmod/game.GetAmmoTypes
...
---@realm server
---@source https://wiki.facepunch.com/gmod/game.GetGlobalCounter
...
--- See [Global States](https://wiki.facepunch.com/gmod/Global_States) for more information.
---@realm server
---@source https://wiki.facepunch.com/gmod/game.GetGlobalState
...
---@realm shared
---@source https://wiki.facepunch.com/gmod/game.GetIPAddress
...
---@realm shared
---@realm menu
---@source https://wiki.facepunch.com/gmod/game.GetMap
...
---@realm server
---@source https://wiki.facepunch.com/gmod/game.GetMapChangeCount
...
---@realm server
---@source https://wiki.facepunch.com/gmod/game.GetMapNext
...
---@realm server
---@source https://wiki.facepunch.com/gmod/game.GetMapVersion
...
---@realm shared
---@source https://wiki.facepunch.com/gmod/game.GetSkillLevel
...
--- ```
---@realm shared
---@source https://wiki.facepunch.com/gmod/game.GetTimeScale
...
---@realm shared
---@source https://wiki.facepunch.com/gmod/game.GetWindSpeed
...
---@realm shared
---@source https://wiki.facepunch.com/gmod/game.GetWorld
...
---@realm shared
---@source https://wiki.facepunch.com/gmod/game.IsDedicated
...
---@realm server
---@source https://wiki.facepunch.com/gmod/game.KickID
...
---@realm server
---@source https://wiki.facepunch.com/gmod/game.LoadNextMap
...
---@realm server
---@source https://wiki.facepunch.com/gmod/game.MapLoadType
...
---@realm shared
---@source https://wiki.facepunch.com/gmod/game.MaxPlayers
...
---@realm shared
---@source https://wiki.facepunch.com/gmod/game.MountGMA
...
---@realm shared
---@source https://wiki.facepunch.com/gmod/game.RemoveRagdolls
...
--- See [Global States](https://wiki.facepunch.com/gmod/Global_States) for more information.
---@realm server
---@source https://wiki.facepunch.com/gmod/game.SetGlobalCounter
---@param name string The name of the Global State to set.
---
--- If the Global State by that name does not exist, it will be created.
---
...
--- See [Global States](https://wiki.facepunch.com/gmod/Global_States) for more information.
---@realm server
---@source https://wiki.facepunch.com/gmod/game.SetGlobalState
---@param name string The name of the Global State to set.
---
--- If the Global State by that name does not exist, it will be created.
---
...
---@realm server
---@source https://wiki.facepunch.com/gmod/game.SetSkillLevel
...
---@realm server
---@source https://wiki.facepunch.com/gmod/game.SetTimeScale
...
---@realm shared
---@source https://wiki.facepunch.com/gmod/game.SinglePlayer
...
---@realm server
---@source https://wiki.facepunch.com/gmod/game.StartSpot
