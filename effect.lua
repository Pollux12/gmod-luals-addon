...
---@hook EndTouch
---@realm client
---@source https://wiki.facepunch.com/gmod/EFFECT:EndTouch
...
---@hook PhysicsCollide
---@realm client
---@source https://wiki.facepunch.com/gmod/EFFECT:PhysicsCollide
...
---@hook Touch
---@realm client
---@source https://wiki.facepunch.com/gmod/EFFECT:Touch
