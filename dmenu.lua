...
---@return (instance) DMenuOption #Returns the created DMenuOption panel.
...
---@return (instance) DMenu #The created sub DMenu
---@return (instance) DMenuOption #The created DMenuOption
...
---@realm client
---@realm menu
---@source https://wiki.facepunch.com/gmod/DMenu:ChildCount
...
---@realm client
---@realm menu
---@source https://wiki.facepunch.com/gmod/DMenu:GetChild
...
---@realm client
---@realm menu
---@source https://wiki.facepunch.com/gmod/DMenu:Hide
