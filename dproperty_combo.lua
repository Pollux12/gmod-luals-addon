...
---@realm client
---@source https://wiki.facepunch.com/gmod/DProperty_Combo:DataChanged
---@param data any The new data that was selected.
function DProperty_Combo:DataChanged(data) end

---Set the selected option.
---@realm client
---@source https://wiki.facepunch.com/gmod/DProperty_Combo:SetSelected
...
---@realm client
---@source https://wiki.facepunch.com/gmod/DProperty_Combo:Setup
