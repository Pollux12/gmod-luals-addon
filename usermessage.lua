...
---@realm shared
---@source https://wiki.facepunch.com/gmod/usermessage.GetTable
...
--- **WARNING**: Usermessages have a limit of only 256 bytes!
---@realm shared
---@source https://wiki.facepunch.com/gmod/usermessage.Hook
...
---@realm shared
---@source https://wiki.facepunch.com/gmod/usermessage.IncomingMessage
