...
---@realm shared
---@realm menu
---@source https://wiki.facepunch.com/gmod/string.GetChar
...
---@realm shared
---@realm menu
---@source https://wiki.facepunch.com/gmod/string.gfind
...
---@realm shared
---@realm menu
---@source https://wiki.facepunch.com/gmod/string.Implode
...
---@realm shared
---@realm menu
---@source https://wiki.facepunch.com/gmod/string.StartWith
---@param inputStr string String to check.
---@param start string String to check with.
---@return boolean # Whether the first string starts with the second.
...
---@realm shared
---@realm menu
---@source https://wiki.facepunch.com/gmod/string.upper
---@param str string The string to convert.
