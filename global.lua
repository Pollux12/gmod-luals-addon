...
---@overload fun(angle: Angle): Angle
---@overload fun(angleString: string): Angle
...
---@return (instance) DMenu #The created DMenu.
...
---@realm shared
---@realm menu
---@source https://wiki.facepunch.com/gmod/Global.getmetatable
...
---@realm shared
---@realm menu
---@source https://wiki.facepunch.com/gmod/Global.module
...
---@realm shared
---@realm menu
---@source https://wiki.facepunch.com/gmod/Global.newproxy
---@overload fun(userData: userdata): userdata
...
---@realm shared
---@realm menu
---@source https://wiki.facepunch.com/gmod/Global.next
...
---@realm shared
---@realm menu
---@source https://wiki.facepunch.com/gmod/Global.print
---@param ... any List of values to print.
...
---@realm shared
---@realm menu
---@source https://wiki.facepunch.com/gmod/Global.rawequal
...
---@realm shared
---@realm menu
---@source https://wiki.facepunch.com/gmod/Global.rawset
...
---@realm shared
---@realm menu
---@source https://wiki.facepunch.com/gmod/Global.tostring
