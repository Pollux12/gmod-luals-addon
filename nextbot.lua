...
---@hook OnTraceAttack
---@realm server
---@source https://wiki.facepunch.com/gmod/NEXTBOT:OnTraceAttack
---@param info CTakeDamageInfo The damage info
...
---@hook RunBehaviour
---@realm server
---@source https://wiki.facepunch.com/gmod/NEXTBOT:RunBehaviour
