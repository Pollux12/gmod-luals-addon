...
---@realm shared
---@realm menu
---@source https://wiki.facepunch.com/gmod/Vector:DotProduct
...
---@realm shared
---@realm menu
---@source https://wiki.facepunch.com/gmod/Vector:GetNormal
...
---@realm shared
---@realm menu
---@source https://wiki.facepunch.com/gmod/Vector:Zero
