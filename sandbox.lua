...
---@hook AddGamemodeToolMenuCategories
---@realm client
...
---@hook SpawnmenuIconMenuOpen
---@realm client
---@source https://wiki.facepunch.com/gmod/SANDBOX:SpawnmenuIconMenuOpen
