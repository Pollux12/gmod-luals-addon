...
---@realm client
---@realm menu
---@source https://wiki.facepunch.com/gmod/surface.DisableClipping
...
---@overload fun(originX: number, originY: number, radius: number, color: table)
...
---@return PanelPaintState # A table containing the position and render.SetScissorRect boundaries for the Panel currently being drawn.
---
...
---@realm client
---@realm menu
---@source https://wiki.facepunch.com/gmod/surface.ScreenHeight
...
---@realm client
---@realm menu
---@source https://wiki.facepunch.com/gmod/surface.ScreenWidth
...
---@realm client
---@realm menu
---@source https://wiki.facepunch.com/gmod/surface.SetTexture
