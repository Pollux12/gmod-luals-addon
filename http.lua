...
---Launches an asynchronous **GET** request to an HTTP server. Internally calls [Global.HTTP](https://wiki.facepunch.com/gmod/Global.HTTP).
---
...
---@realm shared
---@realm menu
---@source https://wiki.facepunch.com/gmod/http.Post
